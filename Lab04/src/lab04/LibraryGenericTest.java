...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    lib3.checkout(9781843190004L, "BadLuckBrian", 9, 15, 2009);
    lib3.checkout(9781843190011L, "DonaldTrump", 10, 21, 2000);
    lib3.checkout(9781843190677L, "Daddy" , 12, 15, 2007);
    lib3.checkout(9781843192701L, "Jesus", 8, 20, 2010);
    System.out.println(lib3.getInventoryList());
    System.out.println(lib3.getOrderedByAuthor());
    System.out.println(lib3.getOverdueList(month, day, year));
